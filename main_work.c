...
static char sound_led[9][8] = {
{0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ド
{0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//レ
{0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ミ
{0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ファ
{0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ファ#
{0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ソ
{0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},//ラ
{0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, //シ
...
ISR(TIMER1_COMPA_vect){
    ...
    if(cnt == 13){
        cnt = 0;
        sound_cnt++;
        switch(daydream_cafe[sound_cnt]){
            case 0xEE:
                set_led(sound_led[0]);
                break;
            case 0xD4:
...
void set_led(char add_led[8]){
    int n;
    for(n = 0; n <= 7; n++){
        show_led[n] = show_led[n] | add_led[n];
    }
}
